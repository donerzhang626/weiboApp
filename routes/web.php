...
Route::post('/users/followers/{user}', 'FollowersController@store')->name('follows.store');
Route::delete('/users/followers/{user}', 'FollowersController@destroy')->name('follows.destroy');